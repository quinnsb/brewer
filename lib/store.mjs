...
/* One level up: this file lives in lib/ at the repo root. It used to sit in
   api/lib/ and reach up twice, and after the move that pointed outside the
   repo, which readJson quietly turned into an empty catalog rather than an
   error. */
